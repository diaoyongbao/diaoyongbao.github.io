---
layout:    post
title:    "nginx泛域名解析配置及全站https"
subtitle:    "nginx 解析"
date:  2019-12-09 17:59:11.000000000 +09:00
author:    "dyb"
...
由于公司业务，目前需要配置全站的https，但由于子站较多，包括各个地市站点，所以想到了nginx的泛域名解析,而且之前的nginx的配置文件全部都写到了一起，基于种种，修改了nginx的目前的配置方式
